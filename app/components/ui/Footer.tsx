                        ...
                        <div className='flex-1'>
                            <div className=' mt-10  flex-1 space-y-6 justify-between sm:flex md:space-y-0'>
                                ...
                                <ul className='space-y-3 text-base-content'>
                                    <Logo />
                                    <br />
                                    <h4 className='text-base-content'>08 Rue, Minontchou</h4>
                                    <h4 className='text-base-content'>Benin, Cotonou</h4>
                                    <br />
                                    { /*-use a map loop*/}
                                    <li>
                                        <b>Tel: </b>+229 0158186569
                                    </li>
                                    <li>
                                        <b>Email: </b>akowakou.dev@gmail.com
                                    </li>
                    ...
                    <div className='mt-10 py-10 border-t items-center justify-center sm:flex'>
                        <div>
                            <p className='text-base-content text-center'>
                                &copy; 2025 devakowakou | Community. Tous Droits reservés.
                            </p>
                            <p className=' text-center'>
                                Editer par <span className=' text-blue-500'>devakowakou</span>
                            </p>
                        </div>
